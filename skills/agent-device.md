...
CLI to control iOS and Android devices for AI agents. Token-efficient alternative to iOS Simulator MCP.
...
- **iOS**: Simulator (full support) + limited device support
...
- **Inspection**: snapshot (accessibility tree)

## Comparison with iOS Simulator MCP

| Feature | iOS Simulator MCP | Agent Device |
|---------|------------------|--------------|
| Token efficiency | Lower | Higher (compact refs) |
| Android support | No | Yes |
| Real device support | Limited | Limited iOS, full Android |
| Snapshot formats | Single | Multiple (ax, xctest, hybrid) |
